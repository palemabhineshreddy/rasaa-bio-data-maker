...
const SAMPLE_BY_TEMPLATE = {
  ...
  peacock: {
    ...
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'hide',
    customFields: [
  ...
  mandala: {
    ...
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'hide',
    customFields: [
      { id: 's1', section: 'personal', customTitle: '', label: 'Languages Known', value: 'Punjabi, Hindi, English' },
      { id: 's2', section: 'personal', customTitle: '', label: 'Religious Practice', value: 'Amritdhari Sikh, regular Gurdwara visits' },
      { id: 's3', section: 'custom', customTitle: 'Partner Expectations', label: 'Religion', value: 'Sikh (Amritdhari preferred)' },
      { id: 's4', section: 'custom', customTitle: 'Partner Expectations', label: 'Profession', value: 'Professional / Business background' },
      { id: 's5', section: 'custom', customTitle: 'Partner Expectations', label: 'Age Range', value: '29–35 years' },
      { id: 's6', section: 'custom', customTitle: 'Partner Expectations', label: 'Location', value: 'Mumbai / Delhi / Canada / UK' },
    ],
  },
  celestial: {
  ...
  minimal: {
    fullName: 'Disha Shah', dateOfBirth: '1998-06-20', age: '26', gender: 'Female',
    height: "5'4\"", weight: '54 kg', bloodGroup: 'A+',
    religion: 'Jain', caste: 'Shwetambar', subCaste: '', motherTongue: 'Gujarati',
    education: 'B.Com + Company Secretary', college: 'H.R. College of Commerce, Mumbai',
    occupation: 'Company Secretary', company: 'Reliance Industries', income: '12 LPA', workLocation: 'Mumbai',
    ...
    hobbies: 'Classical Dance, Yoga, Travelling', about: 'Vegetarian, value-driven, spiritual — believes in simple living and ethical practices',
    rashi: 'Mithuna', nakshatra: 'Punarvasu', gotra: '', manglik: 'No',
    address: '34, Walkeshwar Road', city: 'Mumbai', state: 'Maharashtra',
    phone: '+91 90000 00000', email: 'disha.shah@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'hide', customFields: [],
  },
  royal: {
    fullName: 'Prerna Rathore', dateOfBirth: '1997-08-14', age: '27', gender: 'Female',
    height: "5'5\"", weight: '56 kg', bloodGroup: 'B+',
    religion: 'Hindu', caste: 'Rajput', subCaste: 'Rathore', motherTongue: 'Hindi',
    education: 'MBA (Marketing)', college: 'MDI Gurgaon',
    occupation: 'Brand Manager', company: 'Hindustan Unilever', income: '18 LPA', workLocation: 'New Delhi',
    fatherName: 'Vikram Singh Rathore', fatherOccupation: 'IPS Officer (Retd.)',
    motherName: 'Meenakshi Rathore', motherOccupation: 'Homemaker',
    brothers: '1 Elder Brother (Army Officer)', sisters: 'None',
    familyType: 'Joint', familyStatus: 'Affluent', nativePlace: 'Jodhpur, Rajasthan',
    hobbies: 'Classical Music, Horse Riding, Fine Arts', about: 'Proud of heritage, forward-thinking — balances tradition with ambition gracefully',
    rashi: 'Simha', nakshatra: 'Purva Phalguni', gotra: 'Kashyapa', manglik: 'No',
    address: '7, Friends Colony East', city: 'New Delhi', state: 'Delhi',
    phone: '+91 90000 00000', email: 'prerna.rathore@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'hindi', customFields: [],
  },
  modern: {
    fullName: 'Nithya Krishnan', dateOfBirth: '1999-04-05', age: '25', gender: 'Female',
    height: "5'4\"", weight: '55 kg', bloodGroup: 'O+',
    religion: 'Hindu', caste: 'Iyengar', subCaste: '', motherTongue: 'Tamil',
    education: 'B.Tech (AI & ML)', college: 'IIT Madras',
    occupation: 'Data Scientist', company: 'Flipkart', income: '24 LPA', workLocation: 'Bengaluru',
    fatherName: 'Krishnamurthy V.', fatherOccupation: 'Software Architect',
    ...
    hobbies: 'Bharatanatyam, Machine Learning, Carnatic Vocal', about: 'Tech-driven yet rooted in culture — passionate about AI for social good',
    rashi: 'Mesha', nakshatra: 'Ashwini', gotra: 'Atreya', manglik: 'No',
    address: '15, Indiranagar 12th Main', city: 'Bengaluru', state: 'Karnataka',
    phone: '+91 90000 00000', email: 'nithya.k@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'tamil', customFields: [],
  },
  amethyst: {
    fullName: 'Lalitha Rao', dateOfBirth: '1997-09-18', age: '27', gender: 'Female',
    height: "5'4\"", weight: '56 kg', bloodGroup: 'A+',
    religion: 'Hindu', caste: 'Brahmin', subCaste: 'Madhwa', motherTongue: 'Kannada',
    education: 'M.Sc (Data Science)', college: 'IISc Bengaluru',
    occupation: 'Research Scientist', company: 'Microsoft Research India', income: '20 LPA', workLocation: 'Bengaluru',
    ...
    hobbies: 'Veena, Astronomy, Trekking', about: 'Inquisitive and grounded — blends scientific curiosity with a love for classical arts',
    rashi: 'Vrishchika', nakshatra: 'Anuradha', gotra: 'Vatsa', manglik: 'No',
    address: '56, Jayanagar 4th Block', city: 'Bengaluru', state: 'Karnataka',
    phone: '+91 90000 00000', email: 'lalitha.rao@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'kannada', customFields: [],
  },
  ember: {
    fullName: 'Aarohi Desai', dateOfBirth: '1998-12-05', age: '26', gender: 'Female',
    height: "5'4\"", weight: '55 kg', bloodGroup: 'B-',
    religion: 'Hindu', caste: 'Patel', subCaste: 'Kadva', motherTongue: 'Gujarati',
    education: 'B.Pharm + MBA (Healthcare)', college: 'NMIMS Mumbai',
    occupation: 'Healthcare Consultant', company: 'McKinsey & Company', income: '26 LPA', workLocation: 'Ahmedabad',
    ...
    brothers: '1 Elder Brother (USA)', sisters: 'None',
    familyType: 'Nuclear', familyStatus: 'Business Family', nativePlace: 'Surat, Gujarat',
    hobbies: 'Garba, Entrepreneurship, Photography', about: 'Driven and vibrant — equally at home in boardrooms and on the dance floor',
    rashi: 'Dhanu', nakshatra: 'Purva Ashadha', gotra: 'Kashyapa', manglik: 'No',
    address: '18, Bodakdev', city: 'Ahmedabad', state: 'Gujarat',
    phone: '+91 90000 00000', email: 'aarohi.desai@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'gujarati', customFields: [],
  },
  rose: {
    ...
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'odia', customFields: [],
  },
  midnight: {
    fullName: 'Anika Bedi', dateOfBirth: '1998-07-19', age: '26', gender: 'Female',
    height: "5'6\"", weight: '58 kg', bloodGroup: 'AB+',
    ...
    occupation: 'Corporate Lawyer', company: 'Trilegal', income: '22 LPA', workLocation: 'Mumbai',
    ...
    hobbies: 'Contemporary Dance, Crime Fiction, Travel', about: 'Sharp-minded and empathetic — advocates for fairness inside and outside the courtroom',
    rashi: 'Karka', nakshatra: 'Ashlesha', gotra: 'Atreya', manglik: 'No',
    address: '12, Bandra West', city: 'Mumbai', state: 'Maharashtra',
    phone: '+91 90000 00000', email: 'anika.bedi@email.com',
    photo: priyaPhoto, photoPosition: { x: 50, y: 20 }, sloganLanguage: 'hindi', customFields: [],
  },
}
